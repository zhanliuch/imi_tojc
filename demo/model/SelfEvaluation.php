...
class SelfEvaluation extends Entity
{
    ...
    public static function getAllByArticleId($article_id)
    {
        $evaluations = array();

        $entity = new SelfEvaluation();
        $res = $entity->getRowsFromQuery("SELECT * FROM SELF_EVALUATION WHERE ARTICLE_ID=" . $article_id);
	...
	public function save()
	{
        ...
        $query="INSERT INTO SELF_EVALUATION(SELF_EVALUATION_VALIDATION, ARTICLE_ID, INDICATOR_ID) VALUES('".$this->validation."', ".$this->article_id.", ".$this->indicator_id.")";
