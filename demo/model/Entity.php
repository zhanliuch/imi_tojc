...
class Entity
{
	...
	public function getAllRows($orderBy = "")
	{
        ...
        if($this->table_name == "IndicatorCategory")
            $this->table_name = "INDICATOR_CATEGORY";
	...
	{
	    //we want to delete everything related to the article in order to keep our database clean
